...
containers, i.e. the column venv-docker matches what would have been
...
\jax.
%
Finally, we do a deeper analysis on these bugs. We find some bugs that
...
\begin{lstlisting}[language=bash,basicstyle=\small,keywords={}]
$> run-tool -c freefuzz -l pytorch -v 2.2.0 \
...
ASSERT FAILED at "../aten/src/ATen/native/cpu/Loops.h":310, please
