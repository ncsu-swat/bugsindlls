...
\title{\tname: A Database of Bugs in Deep Learning Libraries to
  Enable the Evaluation of Testing Techniques}
...
\begin{abstract}
  ...
  libraries~(DLL), such as \torch{} and \tf{}, provide the building
  ...
  An impressive number of techniques have been recently proposed to
  find those bugs, but the lack of curated set of reproducible bugs
  hinders credible evaluation of those techniques. We present \tname,
  a database of curated reproducible bugs to fill that gap.
