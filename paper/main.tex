...
literature to find bugs on these libraries. Unfortunately, the lack of
a dataset of reproducible bugs in those libraries poses a barrier to
a proper evaluation of these techniques. \tname{} fills the gaps by 
