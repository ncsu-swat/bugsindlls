...
def test_f():
    ...
    pickle_url = "https://github.com/GwiHwan-Go/repo/raw/main/issues/pickles/torch_issue_118266.pkl"
    ...
    class Model(nn.Module):
        ...
        def forward(self, input, out): 
            out = torch.argmax(input=torch.log1p(out=out, input=input))        
            return out

    out1 = torch.rand([10, 9, 8], dtype=torch.float32)
    out2 = out1.clone()
